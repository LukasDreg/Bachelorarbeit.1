...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private TextView textViewAxis1Position;
    private TextView textViewAxis2Position;
    ...
    private int[][] servoValue = new int [16][2];
    ...
    private String firstStartPositions = "90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,";
    ...
    private void tryCreate() throws IOException {
        ...
        TextViewBlInfo =findViewById(R.id.textView1);
        textViewAxis1Position =findViewById(R.id.textView2);
        textViewAxis2Position =findViewById(R.id.textView3);

        //Get text view objects by id
        buttonAxis1Pos =findViewById(R.id.button1);
        buttonAxis1Neg =findViewById(R.id.button2);
        buttonAxis2Pos =findViewById(R.id.button3);
        buttonAxis2Neg =findViewById(R.id.button4);
